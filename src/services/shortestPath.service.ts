...
//         }
//         graph[road.start_location_id.toString()].push({ id: road.end_location_id, distance: road.distance });

//         if (!graph[road.end_location_id]) {
//             graph[road.end_location_id] = [];
//         }
//         graph[road.end_location_id].push({ id: road.start_location_id, distance: road.distance });
//     });
